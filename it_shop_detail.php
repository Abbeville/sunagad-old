<?php
  ...
  if (isset($_GET['product'])) {
    ...
    $result = Site::products($product_slug, 'slug');
          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                ...
                <li> <a class="active" href="it_shop.php">Shop</a>
                  <ul>
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-12 col-md-12">
            <div class="product_detail_feature_img hizoom hi2">
              <div class='hizoom hi2'> <img src="<?php echo Url::host()."/images/".$product->image; ?>" alt="#" /> </div>
            </div>
          </div>
