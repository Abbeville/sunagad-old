        ...
        <div class="row">
          <div class="full">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 contant_form">
              <h2 class="text_align_center">ADMIN LOGIN</h2>
              <div class="form_section">
                <form id="loginform" class="form_contant" action="ajax/_login.php">
                  <fieldset>
                  <div class="row">
                    <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <input class="field_custom username" placeholder="Username" name="username" type="text">
                    </div>
                    <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <input class="field_custom password" name="password" placeholder="Password" type="password">
                    </div>
